                    ...
                    {items.map((item) => (
                        <SidebarMenuItem key={item.title}>
                            <SidebarMenuButton
                                asChild={!!item.url}
                                isActive={
                                    // this logic is a bit weird but it allows us to check if the current pathname starts with the menu item's url, which is useful for nested routes. For example, if the menu item url is "/dashboard", it will be active for both "/dashboard" and "/dashboard/settings".
                                    item.url
                                        ? item.url === "/"
                                            ? pathname === "/"
